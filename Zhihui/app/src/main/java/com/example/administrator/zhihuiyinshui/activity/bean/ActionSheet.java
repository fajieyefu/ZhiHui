...
{
	/* 控件的id */
	@android.support.annotation.IdRes private static final int CANCEL_BUTTON_ID = 100;
	@android.support.annotation.IdRes private static final int BG_VIEW_ID = 10;
	@android.support.annotation.IdRes private static final int TRANSLATE_DURATION = 300;
	@android.support.annotation.IdRes private static final int ALPHA_DURATION = 300;
