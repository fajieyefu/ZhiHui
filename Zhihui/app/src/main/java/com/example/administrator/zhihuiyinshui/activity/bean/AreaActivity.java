...
/**
 * Created by Fajieyefu on 2016/9/1.
 */
public class AreaActivity extends Activity implements OnWheelChangedListener,View.OnClickListener  {
...
//          InputStream input = asset.open("assets/province_data.xml");
            InputStream input=AreaActivity.this.getClass().getClassLoader().getResourceAsStream("assets/province_data.xml");
            // 创建一个解析xml的工厂对象
    ...
    private void showSelectedResult() {
        ...
        intent.putExtra("data_return",mCurrentProviceName+mCurrentCityName+mCurrentDistrictName);
        setResult(RESULT_OK,intent);
        finish();
//        Toast.makeText(AreaActivity.this, "当前选中:" + mCurrentProviceName + "," + mCurrentCityName + ","
