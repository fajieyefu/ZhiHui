...
public class ImageBrowsePresenter {
    ...
    public void loadImage(){
        ...
        images = (List<DrinkInfo>) intent.getSerializableExtra("images");
    ...
    public void saveImage(){
        ...
        final String imageUrl = images.get(position).getDrink_pic();
    ...
    public String getPositionImage(){
        return images.get(position).getDrink_pic();
    }

    public List<DrinkInfo> getImages() {
        return images;
    }
